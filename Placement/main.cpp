...
int main(int argc, char *argv[])
{
	...
	gArg.Init( argc, argv );                    //extern CArgHandler gArg; (in arghandler.h)
    if( !handleArgument( argc, argv, param ) )  //extern CParamPlacement param; (in ParamPlacement.h)
        return -1;
